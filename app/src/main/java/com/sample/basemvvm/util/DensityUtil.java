package com.sample.basemvvm.util;
...
import com.sample.basemvvm.app.MvvmApplication;
...
public class DensityUtil {
    ...
    public static int dip2px(float dpValue) {
        final float scale = MvvmApplication.getInstance().getResources().getDisplayMetrics().density;
    ...
    public static void formatHeight(View imageView, float bili, int type, int marginLR, int marginTop, int marginBottom) {
        WindowManager wm = (WindowManager) MvvmApplication.getInstance().getSystemService(Context.WINDOW_SERVICE);
