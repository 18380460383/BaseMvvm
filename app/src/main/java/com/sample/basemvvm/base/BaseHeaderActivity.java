package com.sample.basemvvm.base;
...
import com.sample.basemvvm.databinding.BaseHeaderTitleBarBinding;
import com.sample.basemvvm.util.CommonUtils;
import com.sample.basemvvm.util.PerfectClickListener;
import com.sample.basemvvm.widget.CustomChangeBounds;
import com.sample.basemvvm.widget.MyNestedScrollView;
...
//        bindingTitleView.tbBaseTitle.setSubtitleTextAppearance(this, R.style.Toolbar_SubTitle);
    ...
    protected void initSlideShapeTheme(String imgUrl, ImageView mHeaderBg) {
        ...
        final int headerBgHeight = toolbarHeight + StatusBarViewUtil.getStatusBarHeight(this);
        ...
        if (mHeaderBg != null) {
            ...
            layoutParams.setMargins(0, -StatusBarViewUtil.getStatusBarHeight(this), 0, 0);
    ...
    private void initNewSlidingParams() {
        int titleBarAndStatusHeight = (int) (CommonUtils.getDimens(R.dimen.nav_bar_height) + StatusBarViewUtil.getStatusBarHeight(this));
        // 减掉后，没到顶部就不透明了
