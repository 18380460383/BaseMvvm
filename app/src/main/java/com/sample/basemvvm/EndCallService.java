...
public class EndCallService extends Service {
    ...
    private class MyPhoneStateListener extends PhoneStateListener {
        ...
        public void onCallStateChanged(int state, final String incomingNumber) {
            ...
            if (state == TelephonyManager.CALL_STATE_RINGING) {
                Log.e("endCall"," onCallStateChanged 1");
                // 获取拦截模式
                // 挂断电话 1.5
                endCall1();
                //endCall();
                ...
                Log.e("endCall"," onCallStateChanged 2");
            }
        }
    }
    ...
    private final static String TAG="endCall";
    /**
     * 挂断电话
     */
    public void endCall() {
        ...
        try {
            ...
            //receiver : 类的实例
            //args : 具体的参数
            //IBinder invoke = (IBinder) method.invoke(null, new Object[] { "phone" });
            IBinder invoke = (IBinder) method.invoke(null, Context.TELEPHONY_SERVICE);
            //aidl
            ITelephony iTelephony = ITelephony.Stub.asInterface(invoke);
            //挂断电话
            iTelephony.endCall();
            Log.e("endCall"," endCall1 ");
        } catch (Exception e) {
            // TODO Auto-generated catch block
            Log.e("endCall"," endCall "+e.toString());
            e.printStackTrace();
        }
    }
}
